      ...
      <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          <div className="relative navBar">
            ...
            <div className="absolute -top-1 -right-2 bg-red-500 rounded-full items-center justify-center animate-pulse text-white flex hidden lg:inline  text-sm w-5 h-5 ">3</div>
          </div>
